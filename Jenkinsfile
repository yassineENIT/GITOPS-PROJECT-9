pipeline {
    agent any
    environment {
        DOCKER_HUB_REPO ="yassineenit/gitops-project"
            ...
            steps {
                script {
                    ...
                    kubeconfig(credentialsId: 'kubeconfig', serverUrl: 'https://192.168.49.2:8443') {
                        sh '''
                        argocd login 34.76.5.244:32531 --username admin --password $(kubectl get secret -n argocd argocd-initial-admin-secret -o jsonpath="{.data.password}" | base64 -d) --insecure
